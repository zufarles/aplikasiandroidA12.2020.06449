import 'package:arlogi/Components/Admin/DataBarangAdminComponent.dart';
...
class DataBarangAdminScreens extends StatelessWidget {
  static var routeName = "/list_barang_admin_screens";
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: DataBarangAdminComponents(),
    );
  }
}
